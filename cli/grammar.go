...
func (g *GetGrammar) Run(ctx *kong.Context) error {
	bd, err := db.GetClient()
	if err != nil {
		return err
	}
	err = bd.View(func(tx *buntdb.Tx) error {
...
func (d *DelGrammar) Run(ctx *kong.Context) error {
	bd, err := db.GetClient()
	if err != nil {
		return err
	}
...
func (s *ShowGrammar) Run(ctx *kong.Context) error {
	bd, err := db.GetClient()
	if err != nil {
		return err
	}
...
func (k KeysGrammar) Run(ctx *kong.Context) error {
	bd, err := db.GetClient()
	if err != nil {
		return err
	}
...
func (u *UseGrammar) Run(ctx *kong.Context) error {
